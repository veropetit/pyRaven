...
def loop(param, datapacket, path=''):
    ...
    for ind_i, incl in enumerate(param['grid']['incl_grid']):
        ...
        for o in range(0, datapacket.nobs):
            chi2V_data.append(rav_BayesObjects.create_chi(param['grid']['beta_grid'], param['grid']['Bpole_grid'], param['grid']['phase_grid'],
                                            incl, datapacket.obs_names[o] ))
        chi2N1_data = []
        for o in range(0, datapacket.nobs):
            chi2N1_data.append(rav_BayesObjects.create_chi(param['grid']['beta_grid'], param['grid']['Bpole_grid'], param['grid']['phase_grid'],
                                            incl, datapacket.obs_names[o] ))
